...
class CustomTokenizer:
    def __init__(self, vocab_file=None, max_length=512):
        self.tokenizer = BertTokenizer.from_pretrained('bert-base-uncased')  # 或加载自定义 vocab
...
print(tokenizer.detokenize(result['input_ids'][0].tolist()))  # "Hello, world! This is a test."