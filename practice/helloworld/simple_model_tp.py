...
class SimpleModel(nn.Module):
    ...
    def forward(self, x: Tensor):
        return self.linear2(self.linear1(self.embedding(x)))
...
if __name__ == "__main__":
    ...
    mesh = init_device_mesh(device_type="cpu", mesh_shape=(world_size,))

    # device_mesh = DeviceMesh("cpu", list(range(_world_size)))
    ...
    optimizer = optim.Adam(tp_model.parameters(), lr=0.002)
